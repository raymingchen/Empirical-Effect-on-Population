...
{
intialOrderingMatrix=matrix(0,95,T);
iNTERPartIndex=INTERPartIndex(L,T);
  for(t in 1:T)
  {
...
pVec=c(5,3,1,2,4);qVec=c(2,5,1,4,3);L=5;T=8;t=1;
pVec=c(5,3,1,2,4);qVec=c(2,5,1,4,3);L=5;T=8;t=2;
pVec=c(5,2,3,1,4);qVec=c(4,3,1,2,5);L=5;T=8;t=3;
pVec=c(1,6,2,3,4,5);qVec=c(5,4,3,2,6,1);L=6;T=8;t=4;
pVec=c(3,6,5,1,4,2);qVec=c(5,2,1,3,6,4);L=6;T=4;t=3;
pVec=c(7,3,6,5,1,4,2);qVec=c(5,2,1,7,3,6,4);L=7;T=8;t=5;
pVec=c(7,3,6,5,1,4,2,8,9);qVec=c(5,8,2,1,9,7,3,6,4);L=9;T=8;
...
par(mfrow=c(4,2));
plot(sort(vfE_P_gr_2014_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~food, 2014");
plot(sort(vfE_P_gr_2015_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~food, 2015");
plot(sort(vfE_P_gr_2016_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~food, 2016");
plot(sort(vfE_P_gr_2017_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~food, 2017");
plot(sort(vfE_P_gr_2018_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~food, 2018");
plot(sort(vfE_P_gr_2019_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~food, 2019");
plot(sort(vfE_P_gr_2020_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~food, 2020");
plot(sort(vfE_P_gr_2021_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~food, 2021");
...
par(mfrow=c(4,2));
plot(sort(veE_P_gr_2014_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~env, 2014");
plot(sort(veE_P_gr_2015_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~env, 2015");
plot(sort(veE_P_gr_2016_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~env, 2016");
plot(sort(veE_P_gr_2017_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~env, 2017");
plot(sort(veE_P_gr_2018_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~env, 2018");
plot(sort(veE_P_gr_2019_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~env, 2019");
plot(sort(veE_P_gr_2020_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~env, 2020");
plot(sort(veE_P_gr_2021_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~env, 2021");
...
par(mfrow=c(4,2));
plot(sort(vfeE_P_gr_2014_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~food&env, 2014");
plot(sort(vfeE_P_gr_2015_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~food&env, 2015");
plot(sort(vfeE_P_gr_2016_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~food&env, 2016");
plot(sort(vfeE_P_gr_2017_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~food&env, 2017");
plot(sort(vfeE_P_gr_2018_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~food&env, 2018");
plot(sort(vfeE_P_gr_2019_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~food&env, 2019");
plot(sort(vfeE_P_gr_2020_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~food&env, 2020");
plot(sort(vfeE_P_gr_2021_Perm),xlab="sample sizes",ylab="s/n ratio",main="Pop. growth rate~food&env, 2021");
...
##-- food ~ environment
par(mfrow=c(4,2));
plot(sort(vfVe_P_gr_2014_Perm),xlab="sample sizes",ylab="relative ratio",main="food/env, 2014");
plot(sort(vfVe_P_gr_2015_Perm),xlab="sample sizes",ylab="relative ratio",main="food/env, 2015");
plot(sort(vfVe_P_gr_2016_Perm),xlab="sample sizes",ylab="relative ratio",main="food/env, 2016");
plot(sort(vfVe_P_gr_2017_Perm),xlab="sample sizes",ylab="relative ratio",main="food/env, 2017");
plot(sort(vfVe_P_gr_2018_Perm),xlab="sample sizes",ylab="relative ratio",main="food/env, 2018");
plot(sort(vfVe_P_gr_2019_Perm),xlab="sample sizes",ylab="relative ratio",main="food/env, 2019");
plot(sort(vfVe_P_gr_2020_Perm),xlab="sample sizes",ylab="relative ratio",main="food/env, 2020");
plot(sort(vfVe_P_gr_2021_Perm),xlab="sample sizes",ylab="relative ratio",main="food/env, 2021");
...
AAFab[t]=sum(unlist(as.matrix(AFab[t,,])),na.rm=TRUE)/95;
}
...
seed_95_8_mt=matrix(nrow=95,ncol=8);   
for(t in 1:8)
{
seedVec=vector();
for(k in 2:(L+1))
...
seed_95_8_mt[,t]=seedVec;        ##  seed content matrix
}
...
mean_L_L_mx[L+1,L+1]=sum(unlist(part_L_L_ls),na.rm=T)/95;
return(mean_L_L_mx);
}
...
for(t in 1:8)
{
    for(i in 1:factorial(L))
    {
        for(j in 1:factorial(L))
        {
        AAE_8_facL_facL_ls[[t,i,j]]=sum(unlist(abs_8_facL_facL_ls[[t,i,j]]),na.rm=T)/95;
        }
    }
}
...
for(t in 1:8)
{
    for(i in 1:factorial(L))
    {
          ...
          AAVfe_8_facL_facL_ls[[t,i,j]]=sum/95;
          }
     }
}
